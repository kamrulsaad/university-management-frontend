...
const CreateFacultyPage = () => {
  const [createFaculty, { isLoading }] = useCreateFacultyWithFormDataMutation();
  ...
  const facultyOnSubmit = async (values: any) => {
    ...
    try {
      ...
      if (!!res) message.success("Faculty created successfully");
    } catch (err: any) {
  ...
  return (
    <>
      ...
      <Form submithandler={facultyOnSubmit}>
        {/* faculty information */}
        <div
          style={{
