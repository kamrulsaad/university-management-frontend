...
const ACSemesterPage = () => {
  ...
  const [deleteSemester] = useDeleteAcademicSemesterMutation();

  const academicFaculties = data?.academicSemesters;
      ...
      <ActionBar title="Academic Semester List">
        ...
        <div>
          <Link href="/admin/academic/semester/create">
            <Button type="primary">Create Academic Semester</Button>
          </Link>
